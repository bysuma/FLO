...
const stats = [
  {
    ...
    description: 'Decades of engineering and field experience.',
  },
  {
    value: '8+',
    title: 'Public & Private Partnerships',
    description: 'Trusted by Public Agencies & Private Partners',
  },
  {
    value: '20+',
    title: 'Projects completed',
    description: 'From small repairs to major infrastructure builds.',
  },
  {
    value: '100%',
    title: 'On-time delivery',
    description: 'We finish what we start, when we say we will.',
  },
]
      ...
      >
        <div ref={photoRef} className="absolute inset-0">
          <BackgroundPhoto
            ...
            mobileSrc="/results/background-mobile.webp"
          />
        </div>
        <div className="absolute inset-0 bg-linear-to-b from-black/53 to-[#66666688] max-md:from-black/45 max-md:to-black/45" />
      </div>
      <div className="flex flex-col items-center gap-7 px-6 max-md:gap-5 max-md:px-0 text-center text-white">
        <TextReveal
          as="h2"
          id="results-heading"
          className="max-w-md font-display text-section max-md:font-sans max-md:text-results-heading-mobile max-md:text-balance max-md:tracking-normal uppercase"
        >
          4 decades of proven results
        </TextReveal>
        <TextReveal as="p" className="max-w-72 text-body max-md:max-w-66 max-md:leading-[1.313]">
      ...
      <div className="flex flex-col items-center gap-[9px] md:hidden">
        {stats.map((stat, index) => (
          ...
          >
            ...
            <TextReveal
              as="h3"
              className="mt-[10.421px] whitespace-nowrap text-xs leading-normal font-semibold uppercase"
            >
              {index === 3 ? 'Projects completed' : stat.title}
            </TextReveal>
            <TextReveal
              as="p"
