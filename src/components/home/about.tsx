...
export function About() {
  ...
  return <section ref={motionRef} id="about" aria-labelledby="about-heading" className="about-section mt-0.5 relative isolate overflow-clip min-h-177.75 flex flex-col pt-[7.8rem] pr-page pb-4 pl-inset max-md:mt-0 max-md:min-h-[532px] max-md:pt-14 max-md:px-5 max-md:pb-[45px] bg-white">
    ...
    <div className="about-copy items-start [&>p]:[--reveal-delay:240] flex flex-col gap-8 max-md:gap-[25px] lg:flex-row lg:gap-16">
    ...
    <div ref={galleryRef} className="about-gallery min-w-0 mt-[2.85rem] self-end overflow-clip max-md:self-stretch max-md:mt-[3px] max-md:overflow-x-auto max-md:snap-x max-md:snap-mandatory max-md:gap-[3px] max-md:[scrollbar-width:none] [&_img]:min-w-0 [&_img]:flex-1 [&_img]:w-55 [&_img]:h-77 [&_img]:object-cover max-md:[&_img]:w-[158.33px] max-md:[&_img]:flex-none max-md:[&_img]:h-[210px] max-md:[&_img]:snap-start flex gap-2.5">
