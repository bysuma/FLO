import { HeroPreparation } from './hero-preparation'
...
export function Hero() {
  return <HeroPreparation><HeroContent /></HeroPreparation>
}

function HeroContent() {
  const motionRef = useRef<HTMLElement>(null)
  const entrance = useEntrance(motionRef, entrances)
  return <header ref={motionRef} id="home" className="hero sticky top-0 z-0 isolate min-h-190 overflow-clip bg-ink mask-[url('/hero/background.svg')] mask-size-[100%_100%] mask-no-repeat mask-center max-[1100px]:min-h-0 max-md:min-h-[652px] max-md:mask-none min-[1101px]:min-h-[758px]">
    ...
    <div className="hero-content flex items-start gap-0 ml-inset pt-26.75 pb-11.5 max-[1100px]:flex-col max-[1100px]:gap-10 max-[1100px]:ml-0 max-[1100px]:px-page max-[1100px]:pt-14 max-[1100px]:pb-12 max-md:pt-15 max-md:gap-6 max-md:pb-[27px] min-[1101px]:ml-[142px] min-[1101px]:mr-0 min-[1101px]:pt-[107px] min-[1101px]:pb-[44px] min-[1101px]:justify-between">
      ...
      <HeroVideo src="/hero/landscape.mp4" alt="FLO Engineering project video" />
    </div>
  </header>
}
