...
export function Footer() {
  ...
  return <footer ref={motionRef} className="footer relative isolate overflow-clip min-h-149.75 bg-brand [&_a]:transition-colors [&_a]:duration-250 [&_a]:motion-safe:hover:text-white [&_a]:motion-reduce:transition-none [&_address]:[--reveal-stagger:90] [&_li:nth-child(2)]:[--reveal-delay:180] [&_li:nth-child(3)]:[--reveal-delay:260] [&_li:nth-child(4)]:[--reveal-delay:340] section-shell px-page flex flex-col py-8">
    ...
    <div className="flex flex-wrap gap-10 md:gap-16">
      ...
      <div className="ml-auto flex items-start gap-12 max-md:ml-0 max-md:basis-full" aria-label="Social media"><img {...entrance('images', 'image-1')} src="/footer/social-1.svg" width="20" height="20" alt="Facebook" /><img {...entrance('images', 'image-2')} src="/footer/social-2.svg" width="20" height="20" alt="Instagram" /><img {...entrance('images', 'image-3')} src="/footer/social-3.svg" width="20" height="20" alt="LinkedIn" /></div>
    </div>
    <div className="mt-8 flex items-center gap-12"><img {...entrance('images', 'image-4')} src="/footer/dbe.webp" alt="DBE certification" width="54" height="54" className="mix-blend-darken" loading="lazy" decoding="async" /><img {...entrance('images', 'image-5')} src="/footer/sbe.webp" alt="SBE certification" width="54" height="56" className="mix-blend-darken" loading="lazy" decoding="async" /></div>
    <div className="footer-bottom max-md:pt-16 mt-auto flex flex-wrap items-end justify-between gap-8 pt-24">
      <Link to="/" hash="home" aria-label="FLO home" className="flex items-start"><img {...entrance('images', 'image-6')} className="footer-logo w-97.5 h-auto max-[1100px]:w-72 max-md:w-[min(20rem,calc(100vw-3rem))]" src="/footer/logo.svg" width="390" height="182" alt="FLO" /><img {...entrance('images', 'image-7')} src="/footer/trademark.svg" alt="" width="30" height="16" className="-ml-5 mt-1" /></Link>
