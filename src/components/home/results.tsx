...
export function Results() {
  ...
  return <section ref={motionRef} aria-labelledby="results-heading" className="results-section relative isolate overflow-clip min-h-194.75 pt-22.25 max-lg:min-h-0 max-lg:pt-16 max-md:min-h-[869px] max-md:px-5 max-md:py-14 max-md:gap-6.5 [--reveal-delay:0] [--reveal-stagger:70] [--reveal-threshold:.01] flex flex-col"><div {...entrance('backdrop')} className="section-backdrop [background:linear-gradient(#0008,#6668),url('/results/background.webp')_center/cover] max-md:bg-[linear-gradient(#00000073,#00000073),url('/results/background-mobile.webp')] absolute inset-0 -z-10 pointer-events-none" aria-hidden="true" />
    <div className="flex flex-col items-center gap-7 px-6 max-md:gap-5 max-md:px-0 text-center text-white"><TextReveal as="h2" id="results-heading" className="max-w-md font-display text-section max-md:font-sans max-md:text-results-heading-mobile max-md:h-[63px] max-md:tracking-normal uppercase">4 decades of proven results</TextReveal><TextReveal as="p" className="max-w-72 text-body max-md:max-w-66 max-md:leading-[1.313]">We've earned our reputation through consistent work and accountability.</TextReveal></div>
